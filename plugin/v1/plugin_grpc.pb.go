...
const (
	Plugin_Verify_FullMethodName  = "/vatz.plugin.Plugin/verify"
	Plugin_Execute_FullMethodName = "/vatz.plugin.Plugin/execute"
)
...
func (c *pluginClient) Verify(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*VerifyInfo, error) {
	out := new(VerifyInfo)
	err := c.cc.Invoke(ctx, Plugin_Verify_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pluginClient) Execute(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (*ExecuteResponse, error) {
	...
	err := c.cc.Invoke(ctx, Plugin_Execute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Plugin_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Plugin_Verify_FullMethodName,
	}
