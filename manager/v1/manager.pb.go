...
type InitRequest struct {
	...
	Option  *structpb.Struct `protobuf:"bytes,5,opt,name=option,proto3" json:"option,omitempty"`     // mapType 변환
}
...
func (x *InitRequest) GetOption() *structpb.Struct {
	if x != nil {
		return x.Option
	}
	return nil
...
var file_proto_vatz_manager_v1_manager_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x78, 0x65, 0x6c, 0x6c, 0x6f, 0x73, 0x30, 0x30, 0x2f, 0x64, 0x6b, 0x2d,
	0x79, 0x75, 0x62, 0x61, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x76, 0x61, 0x74, 0x7a, 0x2f, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2f, 0x76, 0x31,
